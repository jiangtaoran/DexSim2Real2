...
import sys
# if '/home/guest2/Documents/Sim2Real2/CEM/ManiSkill2' in sys.path:
#   sys.path.remove('/home/guest2/Documents/Sim2Real2/CEM/ManiSkill2')
# if '/home/guest2/Documents/Sim2Real2/CEM/ManiSkill2-Learn' in sys.path:
#   sys.path.remove('/home/guest2/Documents/Sim2Real2/CEM/ManiSkill2-Learn')
# sys.path.append('/data/guest2_documents/work/Sim2Real2-work/CEM/ManiSkill2')
# sys.path.append('/data/guest2_documents/work/Sim2Real2-work/CEM/ManiSkill2-Learn')
sys.path.append('/home/rvsa/CEM/ManiSkill2')
sys.path.append('/home/rvsa/CEM/ManiSkill2-Learn')
...
if __name__ == "__main__":
    ...
    print("总用时",end-start)
# cd Sim2Real2-work/CEM/ManiSkill2-Learn/
# cd ~/CEM/ManiSkill2-Learn/maniskill2_learn/apis
#  python run_rl.py /home/rvsa/CEM/ManiSkill2-Learn/configs/mpc/cem/maniskill2_DigitalTwin_Allegro_inspect.py --gpu-ids 0 --dev

# if you want to change digital twins, go to CEM/ManiSkill2-Learn/configs/mpc/cem/maniskill2_DigitalTwin_Allegro_inspect&_laptop.py
# go to CEM_env_allegro to change intial robot qpos